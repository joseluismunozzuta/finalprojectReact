    ...
    return (
        <>
            ...
            <div class="row justify-content-center">
                ...
                {cond && <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 mt-2 content-center-colum">
                    <button type="button" className="btn btn-info fw-bold text-capitalize" onClick={() => handleClick(id, cuenta)}>Agregar al carrito</button>
                </div>}
            </div>
        </>
    )
